...
MPSBoost 是面向 Apple Silicon 的树模型学习库。当前公开版本为 `0.3.0`，包含 native CPU/MPS 后端、sklearn 风格 estimator、多分类 native CPU softmax、随机森林、ExtraTrees、DecisionTree、CatBoost-like numeric estimator、高级回归目标、解释工具、异常检测和排序学习入口。
